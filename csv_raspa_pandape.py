# -*- coding: utf-8 -*-
"""CSV_Raspa_Pandape.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1sYABFTTIwHglFy7NK_yPxES8l7INwRfH
"""
...
#url
#url1 = "https://pandape.infojobs.com.br/Company/Vacancy"

url = "https://pandape.infojobs.com.br/Company/Match/Matches/3286628?idvacancyfolder=21172696"
...
for i, (_, row) in enumerate(registros.iterrows()):
    ...
    for url_cand in links_para_visitar:
        ...
        try:
            ...
            cpf_cand = "00000000000"
            sexo_cand = "N/A"
            estado_civil_cand = "N/A"
            idade_cand = "N/A"
            nascimento_cand = "1900-01-01"
